...
# File API smoke exercises the command-gateway file primitives (list, mkdir,
# write_bytes, read_bytes, sha256, remove, extract, archive) through the BFF.
...
PYTHONPATH="$root/src" python3 "$root/scripts/smoke_sim_file_api.py"
