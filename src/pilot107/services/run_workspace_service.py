"""Evidence-first read model for one Run workspace.

This module intentionally performs no collection, diagnosis, repair, Agent, or
Slurm actions.  It projects already-persisted Run/Contract/Evidence metadata
into one decision-oriented response for the web workspace.
"""
